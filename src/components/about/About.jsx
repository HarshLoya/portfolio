    ...
    <section id="about" className="about section">
        ...
        <div className="about__container grid container">
            ...
            <div className="about__data">
                ...
                and as a <br /> <strong><>Backend developer</></strong>, I have developed <u>Web servers</u> and <u>REST apis</u> with <strong><u>Nodejs</u></strong>, I have sharpened my skill by making many projects.<br/>(still sharpening)</p>
